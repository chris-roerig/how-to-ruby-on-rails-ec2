...
server {
    ...
    root /home/<user>/www/<yoursite>/current/public;
    ...
    access_log /home/<user>/www/<yoursite>/shared/log/nginx.access.log;
    error_log /home/<user>/www/<yoursite>/shared/log/nginx.error.log;
